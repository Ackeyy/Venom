...
client.on("ready", () => {
    ...
    console.log(red('           ════════════════════════════════════════════════════════════════════════════════'));
    console.log("");
    client.user.setActivity({ type: "PLAYING", name: "Ackerman op" }); // Delete this if you wish.
});
    ...
    if (message.mentions.everyone === true) {
        ...
        const helpEmbed = new Discord.MessageEmbed()
            ...
            **Server Annihilation:** \`${prefix}die\` [text]
            ...
            .setFooter(`© Presser | Prefix: ${prefix} | Author: Ackerman | Cord: ${founder}`)
            .setColor(0x36393E)
